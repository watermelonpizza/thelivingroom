...
public class Player : MonoBehaviour
{
    ...
    private void Fire()
    {
        ...
        StartCoroutine(FreezeMovementForFireFreezeTime());
        StartCoroutine(FreezeFireForFireCooldown());
        Destroy(whooshAttack, .5f);
    }

    private IEnumerator FreezeMovementForFireFreezeTime()
    {
        yield return new WaitForSeconds(settings.fireFreezeTime);
        _canMove = true;
    }

    private IEnumerator FreezeFireForFireCooldown()
    {
